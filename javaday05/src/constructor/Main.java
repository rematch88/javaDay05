...
public class Main {
	...
	public static void main(String[] args) {
		...
		//mem2.setId("root");
		//mem2.setPw("1234");
		System.out.println("mem2id:" + mem2.getId() +"\t"+ "mem2pw:" + mem2.getPw());

		//생성자에 2개의 데이터를 대입해서 인스턴스를 생성
		Member mem3 = new Member("admin", "1000");
		System.out.println("mem3id:" + mem3.getId() +"\t"+ "mem3pw:" + mem3.getPw());
		...
		//복제를 해서 deep 에 대입해주었기 때문에 변경하기 전에는 같은 내용을 갖지만
		//한쪽에서 내용을 변경해도 다른 쪽에는 영향이 없기 때문에 deep의 내용을 변경해도 origin은 그대로
		System.out.println("===============");
		deep.setId("adsp");
		System.out.println(deep.getId());
		System.out.println(origin.getId());
